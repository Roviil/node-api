 ...
 *                   type: string
 */
router.get('/notices', controller.noticesget);
/**
 * @swagger
 * securityDefinitions:
 *  Bearer:
 ...
 */
router.notice('/write', controller.write);
/**
 * @swagger
 * /post/comment:
 *  get:
 ...
 */
router.notice('/updatenotice', controller.updateNotice);
/**
 * @swagger
 ...
 */
router.notice('/deletenotice/:notice_id', controller.deleteNotice);
/**
 * @swagger
 ...
 *                   example: 서버 내부 오류
 */
router.notice('/commentwrite/:notice_id', controller.commentwrite);
/**
 * @swagger
 * /post/deletecomment:
 *   delete:
